 ...
 * it: a visitor in another time zone booking a haircut is booking it at the time
 * printed on the salon's door, and "helpfully" shifting it by five and a half
  ...
  return (
    <section className={styles.panel}>
      ...
      {/* The days the shop actually has something left on. Rendered as buttons
          ...
          clicking that the salon is closed on Sundays. */}
